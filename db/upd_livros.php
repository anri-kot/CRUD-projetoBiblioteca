            ...
            <div id="main-content">
                <div id="main-form">
                    ...
                    <?php 
                        ...
                        $sql = "UPDATE livros set isbn = '$isbn', titulo = '$titulo', autor = '$autor', ano = '$ano', editora = '$editora', paginas = '$paginas'
                            WHERE isbn = '$old_isbn'";
                        ...
                        echo "<br><h1>Registro do livro atualizado com sucesso<h1><br>";
                        mysqli_close($con);
                    ?>
